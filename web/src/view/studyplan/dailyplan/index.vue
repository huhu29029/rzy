    ...
    <el-row>
      ...
      <el-col :span="6">
        <el-card>
          ...
          <div class="card_tips">共{{ questionsTotal }}题</div>
...
export default {
  data() {
    return {
      ...
      nextQuestionId: '',
      daylist: [
        { day: [29, 32, 36, 49, 149, 231, 93] },
        { day: [6, 31, 34, 194, 195, 196, 22, 21] },
        { day: [14, 23, 43, 68, 236, 46, 142, 80, 20] },
        { day: [261, 260, 215, 227, 21, 213] },
      ],
      dateNum: 0,
    };
  },
  ...
  methods: {
    async getQuestionList() {
      this.dateNum = this.$route.query.dateNum;
      this.questionList = this.daylist[this.dateNum - 1].day;
